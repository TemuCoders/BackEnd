...
import pe.edu.upc.center.workstation.reviewsManagement.domain.model.valueobjects.UserId;
import pe.edu.upc.center.workstation.reviewsManagement.infrastructure.acl.UserAclClient;
import pe.edu.upc.center.workstation.shared.domain.exceptions.NotFoundArgumentException;
import org.springframework.stereotype.Service;

@Service("reviewsExternalUserService")
public class ExternalUserService {

    private final UserAclClient userAclClient;

    public ExternalUserService(@Qualifier("reviewsUserAclClient") UserAclClient userAclClient) {
